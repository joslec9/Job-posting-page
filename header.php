...
<div class="header">
        ...
        <div class="header_top">
            ...
            <div class="header_top_res">
						...
						<a id="telf" href="tel:(800)513-5096"><font color="#f75b1e"><strong> Customer Service: <i class="fa fa-phone"></i> 800-513-5096</strong></font></a>
				</div><!-- /header_top_res -->
        ...
        <!--div class="header_menu"-->
            ...
            <!--div class="header_menu_res">
				<!--a href="#menu-header" class="tiny_button_menu slider_trigger"><?php //_e( 'Navigation', APP_TD ); ?></a-->
