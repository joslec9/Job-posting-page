...
if (isset($_POST['submit']) && $_POST['send_email'] == 'yes') {
    ...
    if ($rand_total == $rand_post_total) {
        ...
        cp_contact_ad_owner_email2($post->ID, $_POST['resumes']);
...
?>
   ...
   <form name="mainform" id="mainform" class="form_contact" action="#priceblock2" method="post" enctype="multipart/form-data">
       ...
       <p class="contact_msg"><?php _e('To inquire about this ad listing, complete the form below to send a message to the ad poster.', APP_TD) ?></p>
        ...
        <ol>
            <li>
                ...
                <input name="from_name" id="from_name" type="text" minlength="2" value="<?php if(isset($_POST['from_name']) && !$msg_sent) echo esc_attr( stripslashes($_POST['from_name']) ); ?>" class="text required" />
                <div class="clr"></div>
            </li>

            <li>
                <label><?php _e('Email:', APP_TD) ?></label>
                <input name="from_email" id="from_email" type="text" minlength="5" value="<?php if(isset($_POST['from_email']) && !$msg_sent) echo esc_attr( stripslashes($_POST['from_email']) ); ?>" class="text required email" />
                <div class="clr"></div>
            </li>
            ...
            <li>
                ...
                <textarea name="message" id="message" rows="" cols="" class="text required"><?php if(isset($_POST['message']) && !$msg_sent) echo esc_attr( stripslashes($_POST['message']) ); ?></textarea>
                <div class="clr"></div>
            </li>
       ...
       <input type="hidden" name="resumes[]" id="resumes" value="" />
	...
	<script type="text/javascript">
		jQuery(document).ready(function(){
    		...
    		jQuery.support.fileInput).parent().addClass(jQuery.support.fileInput ? undefined : 'disabled');
     });
    </script>
