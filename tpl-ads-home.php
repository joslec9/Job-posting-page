			...
			<div class="content_left">
				<?php if ( $cp_options->home_layout == 'directory' ) { ?>
					...
					<div class="shadowblock_out">
						...
						<div class="shadowblock">
							...
							<a id="cpro_cat_btn" class="cpro_cat_btn" href="#"></a>

							<h2 class="dotted"><?php _e( 'States', APP_TD ); ?></h2>
				...
				<div class="tabcontrol">
					...
					<ul class="tabnavig">
						...
						<li><a href="#block3"><span class="big"><?php _e( 'Featured', APP_TD ); ?></span></a></li>
					</ul>
					...
					<div id="block3">
              				...
              				<div class="undertab"><span class="big"><?php _e('Classified Ads', APP_TD ) ?> / <strong><span class="colour"><?php _e('Featured Listings', APP_TD ) ?></span></strong></span></div>
						...
						?>
									<div class="paging"><a href="<?php echo $featured_url; ?>"> <?php _e( 'View More Ads', 'auctionPlugin' ); ?> </a></div>
						<?php } ?>
